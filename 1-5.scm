...
;; Applicative order will result in an infinite loop trying to substitute (p)
;; with itself

;; Normal order evaluation will result in 0 because (p) is substitued with (p)
;; once then the evaluation continues, checks the if and returns 0
